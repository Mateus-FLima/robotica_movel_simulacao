...
class ArucoLocator:
    ...
    def print_robot_pose(self, stamp):
        try:
            ...
            target_frame = 'map' if self.tf_buffer.can_transform('map', 'base_link', rospy.Time(0)) else 'odom'
            trans = self.tf_buffer.lookup_transform(target_frame, 'base_link', stamp, rospy.Duration(1.0))
            ...
            try:
                ...
                trans = self.tf_buffer.lookup_transform(target_frame, 'base_link', rospy.Time(0), rospy.Duration(1.0))
            except Exception as e:
